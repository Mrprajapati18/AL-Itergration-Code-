page 80005 CustomerApi
{
    ...
    Caption = 'customerApi';
    DelayedInsert = true;
    EntityName = 'CustApiPage';
    EntitySetName = 'CustApiPage';
    PageType = API;
    ...
    layout
    {
        area(Content)
        {
            repeater(General)
            {
                ...
                field(custSubscriptionContracts; Rec."Cust. Subscription Contracts")
                {
                ...
                field(subscriptionHeaders; Rec."Subscription Headers")
                {
